    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        ...
        $('.pp-section').each(function (index) {
            ...
            if (!index && $('.pp-section.active').length === 0) {
				...
				$(this).css(getTransforms('translate3d(0px, 100%, 0px)')).addClass('s-top');
			}
            ...
            $(window).on('load', function() {
                scrollToAnchor();
				$('.pp-section.active ~ .pp-section').addClass('s-bot pp-easing').removeClass('s-top');
            });
        ...
        */
        function scrollPage(destination, animated) {
            ...
            v.destination.addClass('active s-top').siblings().removeClass('active');
			$('.pp-section.active').prevAll().addClass('s-top').removeClass('s-bot');
			$('.pp-section.active ~ .pp-section').addClass('s-bot').removeClass('s-top');
            ...
            if (v.yMovement === 'down') {
				...
				v.activeSection.addClass('s-top');
				destination.addClass('s-top').removeClass('s-bot');
            ...
            //scrolling up (moving section down to the viewport)
				...
				v.activeSection.removeClass('s-top').addClass('s-bot');
                // v.animateSection = destination;
				v.animateSection = v.activeSection;
            }
        ...
        */
		...
		function destroyStructure(){
			...
			$('.pp-section').each(function(){
				$(this).removeAttr('style').removeAttr('data-anchor').removeClass('pp-section active pp-table s-top s-bot');
			})
